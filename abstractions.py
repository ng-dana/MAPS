...
# Restaurants
#soda_reviews =  [[restaurant,review],...]
...
def restaurant_ratings(restaurant):
    ...
    # list is not organized [4.5,4]
    # BEGIN Question 1
    ratings = []
    for i in restaurant['review']:
        ratings +=[review_rating(i)]
    return ratings
    # END Question 1
...
def restaurant_mean_rating(restaurant):
    ...
    # BEGIN Question 2
    ratings = restaurant_ratings(restaurant)
    num_ratings = restaurant_num_ratings(restaurant)
    sum = 0
    for i in ratings:
        sum += i
